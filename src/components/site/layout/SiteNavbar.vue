...
const navItems = computed(() => [
  ...
  ...(authStore.isAuthenticated ? [{ to: '/dashboard', label: 'Dashboard', icon: 'dashboard' }] : [])
])
...
.site-nav-scanline {
  ...
  opacity: 0.5;
  box-shadow: 0 0 12px var(--nav-cyan);
...
.site-nav-link:hover {
  ...
  box-shadow:
    0 4px 20px -4px rgba(139, 92, 246, 0.25),
...
.site-nav-burger.is-active .site-nav-burger-line:nth-child(3) {
  transform: translateY(-7px) rotate(-45deg);
  box-shadow: 0 0 10px var(--nav-cyan);
}
...
@media (max-width: 768px) {
  ...
  .site-nav-links {
    ...
    transition: opacity 0.45s cubic-bezier(0.34, 1.2, 0.64, 1), visibility 0.45s ease, transform 0.45s cubic-bezier(0.34, 1.2, 0.64, 1), background 0.4s ease;
    z-index: 998;
    padding: 0;
    overflow-y: auto;
    pointer-events: none;
  ...
  .site-nav-dropdown-hexgrid {
    ...
    pointer-events: none;
    animation: navHexShift 20s linear infinite;
  }

  @keyframes navHexShift {
    0% { background-position: 0 0; }
    100% { background-position: 28px 24px; }
  }
  ...
  .site-nav-dropdown-scan {
    ...
    pointer-events: none;
    animation: navScanMove 3s linear infinite;
  }
  ...
  .site-nav-particle {
    ...
    animation-delay: calc(var(--p, 0) * -0.6s);
  ...
  .site-nav-links .site-nav-link {
    ...
    transition: opacity 0.45s cubic-bezier(0.34, 1.2, 0.64, 1), transform 0.45s cubic-bezier(0.34, 1.2, 0.64, 1), border-color 0.3s ease, box-shadow 0.3s ease, background 0.3s ease;
  ...
  .site-nav-links .site-nav-link .site-nav-link-glow {
    ...
    inset: -1px;
    border-radius: inherit;
    background: radial-gradient(ellipse 80% 50% at 50% 0%, rgba(139, 92, 246, 0.2) 0%, transparent 70%);
    opacity: 0;
  ...
  .site-nav-links .site-nav-link:hover {
    ...
    box-shadow: 0 0 40px -8px rgba(139, 92, 246, 0.35), 0 0 0 1px rgba(139, 92, 246, 0.2);
    background: linear-gradient(135deg, rgba(255, 255, 255, 0.07) 0%, rgba(255, 255, 255, 0.02) 100%);
    transform: translateY(-2px) scale(1.02);
  }

  .site-nav-links .site-nav-link:hover .site-nav-link-glow {
    opacity: 1;
  }
  ...
  .site-nav-links .site-nav-link.router-link-active {
    ...
    box-shadow: 0 0 36px -6px rgba(139, 92, 246, 0.4), 0 0 0 1px rgba(139, 92, 246, 0.25);
    background: linear-gradient(135deg, rgba(139, 92, 246, 0.12) 0%, rgba(139, 92, 246, 0.04) 100%);
  }

  .site-nav-links .site-nav-link.router-link-active .site-nav-link-glow {
    opacity: 0.8;
  }
